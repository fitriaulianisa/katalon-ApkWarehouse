...
// Klik field username
WebUI.setText(findTestObject('Object Repository/Password_invalid/Page_SSO - Pupuk Sriwidjaja Palembang/input_Username_form-control'), 
    '1234')

WebUI.setEncryptedText(findTestObject('Password_invalid/Page_SSO - Pupuk Sriwidjaja Palembang/input_Password_form-control'), 
    'BV0dRoAgsGg=')
